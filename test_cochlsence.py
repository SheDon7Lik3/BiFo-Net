...
from dataset.cochlsence import get_cochlscene_test_set
...
class PLModule(pl.LightningModule):
    """
    PyTorch Lightning Module for testing
    """
...
def test(config):
    """
    Test the model on CochlScene test set
    
    Args:
        config: Namespace containing all test configurations
    """
    print("\nStarting CochlScene Test")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CochlScene Test Script')
    ...
    parser.add_argument('--divisor', type=float, default=5,
                       help="Divisor for channel rounding")
